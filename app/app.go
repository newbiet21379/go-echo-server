...
func main() {
	// block to confirm if the runtime environment is for DEVELOPMENT or PRODUCTION
	...
	// name definition for the runtime application (along with the runtime environment variant)
	...
	// Store routes available in the system in a JSON file
